    ...
    <div class="login-form">
      <form id="accordion-form" name="registration-form" class="login-form-block form-signup submit-once" method="post">
        ...
        <div class="accordion-tab<?php if ($formSubmission == 'fail' AND (!$teachLocationName OR !$teachGrades OR !$teachSubjects OR !$teachStart OR !$teachEnd)) echo ' error'; ?>" id="tab-role"><div class="circle">2</div> Your Current Role</div>
        <div class="accordion-panel panel-role">
          <div class="form-node<?php if ($formSubmission == 'fail' AND !$teachLocationName) echo ' error'; ?>">
            <label for="teachLocationName">Where do you currently teach?</label>
          ...
          <div class="form-node<?php if ($formSubmission == 'fail' AND !$teachGrades) echo ' error'; ?>">
          ...
          <div class="form-node<?php if ($formSubmission == 'fail' AND !$teachSubjects) echo ' error'; ?>">
          ...
          <div class="form-node<?php if ($formSubmission == 'fail' AND (!$teachStart OR !$teachEnd )) echo ' error'; ?>">
        ...
        <div class="accordion-tab<?php if ($formSubmission == 'fail' AND (!$teachLicenseLocation OR !$teachLicenseComplete OR !$termsAgreement)) echo ' error'; ?>" id="tab-license"><div class="circle">3</div> Your Teaching License</div>
