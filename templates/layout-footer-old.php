      ...
      <?php if ($page == 'feed' OR $page == 'members' OR $page == 'posts' OR $page == 'following' OR $page == 'followers' OR $page == 'notifications' OR $view == 'inbox') {  ?>
        ...
        <div id="pagination">
          ...
          <?php if ( ($page != 'notifications' AND $total_count == 30) OR ($page == 'notifications' AND $total_count == 20) OR ($view == 'inbox' AND $total_count == 10) ) { ?>
            <a class="show-older-link" href="<?=$url_prev?>"><div class="show-older-container"><img class="icon-button-arrow icon-left svg" src="img/arrow-down.svg"> Show Previous</div></a>
          <?php } ?>

          <?php if ($current_page >= 2) { ?>
            <a class="show-newer-link" href="<?=$url_next?>"><div class="show-newer-container">Show Next <img class="icon-button-arrow icon-right svg" src="img/arrow-down.svg"></div></a><div class="clear"></div>
          <?php } ?>
  ...
  <div id="alert-file-unsupported" class="modal">
    ...
    <div class="modal-actions">
      <a class="modal-button modal-button-outline" href="#!" rel="modal:close">Continue</a>
    </div>
    <div class="clear">
      &nbsp;
    </div>
...
<?php } ?>
  ...
  $.fn.extend({
    ...
    // $(document).on('blur', '#text-search', function() {
    //   $('.search-dropdown').toggleClass("reveal");
    // });
     ...
     */
      ...
      $("#button-new-question").click(function() {
        $.sidr('close', 'site-menu');
        // $('html, body').animate({ scrollTop: 0 }, 0);
        $("#site-search").removeClass("reveal");
        $('.contribute-dropdown').removeClass('reveal');
    ...
    <script type="text/javascript">
      ...
      jQuery(document).ready(function () {
        ...
        function sendMsg() {
          ...
          if (message != '') {
            var cid = $('#cid').val();
            var messageNew = '<div class="notification animated fadeIn"><div class="author"><a href="#"><div class="post-header col-avatar small"><img class="avatar" src="'+ avatar +'"></div><div class="post-header"><div class="author-name"><?=$_SESSION['firstName'].' '.$_SESSION['lastName']?></div><div class="post-time">'+ moment().format('DD MMM h:mma') +'</div></div></a></div><div class="content"><div class="comment-content"><div>'+ message +'</div></div></div></div>';
  ...
  <?php } ?>
    ...
    <?php if ($page == 'view' OR $page == 'feed' OR ($page == 'profile' AND !$action)) { ?>
      <div id="confirm-delete" class="modal">
        ...
        <div class="modal-actions">
          <a id="confirm-delete-button" class="modal-button modal-button-red" href="#!" data-id="<?=$post_id?>" data-type="post">Yes</a> <a class="modal-button modal-button-outline" href="#!" rel="modal:close">No</a>
        </div>
        <div class="clear">
          &nbsp;
        </div>
      ...
      <?php if ($view == 'conversation') { ?>
        <div id="confirm-delete" class="modal">
          ...
          <div class="modal-actions">
            <a id="confirm-delete-button" class="modal-button modal-button-red" href="#!" data-id="<?=$post_id?>" data-type="conversation">Yes</a> <a class="modal-button modal-button-outline" href="#!" rel="modal:close">No</a>
          </div>
          <div class="clear">
            &nbsp;
          </div>
        ...
        <div id="confirm-leave" class="modal">
          ...
          <div class="modal-actions">
            <a id="confirm-leave-button" class="modal-button modal-button-red" href="#!" data-id="<?=$post_id?>" data-type="conversation">Yes</a> <a class="modal-button modal-button-outline" href="#!" rel="modal:close">No</a>
          </div>
          <div class="clear">
            &nbsp;
          </div>
    ...
    <?php if ($page == 'profile' AND $action) { ?>
      ...
      <div id="confirm-delete" class="modal">
        ...
        <div class="modal-actions">
          <a id="confirm-delete-button" class="modal-button modal-button-red" href="#!">Yes</a> <a class="modal-button modal-button-outline" href="#!" rel="modal:close">No</a>
        </div>
        <div class="clear">
          &nbsp;
        </div>
...
$activity_data[] = $_SERVER['REMOTE_ADDR'];
