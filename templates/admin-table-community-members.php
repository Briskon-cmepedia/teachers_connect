...
<div class="row card bootstrapiso">
  ...
  <form id="table-community-members" action="admin-process-members.php" method="POST">
    ...
    <div class="dt-button-edit btn-group"> <input class="btn btn-danger buttons-html5" id="button-member-remove" name="submit" type="submit" value="Remove"> </div>
...
<?php } else { ?>
  ...
  <div class="alert-error">
    There are no members in this community.
  </div>
