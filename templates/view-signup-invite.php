    ...
    <div class="login-callout">
      <div class="login-callout-text partner-logos permanent">
        <div class="invite-partner-logos">
          <img class="logo-partner" src="img/tclogo2.svg" alt="Teachers Connect logo"><div class="space-small">&nbsp;</div><img class="logo-partner" src="image.php?id=<?=$partner_logo?>" alt="<?=$partner_name?> logo">
        </div>
        <b>You are invited to join the <?=$partner_name?> community on TeachersConnect.</b><br><br>
        <?=$partner_description?>
      </div>
    ...
    <div class="login-form">
      <form id="accordion-form" name="registration-form" class="login-form-block form-signup submit-once" method="post">
        ...
        <div class="accordion-panel panel-identity">
          ...
          <input type="hidden" id="userType" name="userType" value="invite">
