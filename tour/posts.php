...
<div id="tour-header">
  ...
  <div class="col50">
    <div class="tour-exit right">
      <a id="tour-exit-posts" href="../home.php"><img src="../img/tour-exit.png"> Exit</a>
    </div>
  </div>
</div>
<div id="tour-navigation">
  ...
  <div class="tour-description col50">
    ...
    <div class="text">
      You can interact with community posts in a variety of ways to make an impact and stay in the loop.
    </div>
  </div>
  <div class="tour-button col25">
    <a href="create.php">
...
<div id="tour-view">
  <img src="../img/tour-communityposts.png">
</div>
<div id="tour-footer">
  <div class="col25">
    &nbsp;
  ...
  <div class="col50">
    <img src="../img/tour-extra.png"> You can click on member names in posts to learn more about that person.
  </div>
  <div class="col25">
    &nbsp;
  </div>
