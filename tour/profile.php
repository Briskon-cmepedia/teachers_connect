...
<div id="tour-header">
  ...
  <div class="col50">
    <div class="tour-exit right">
      <a id="tour-exit-profile" href="../home.php"><img src="../img/tour-exit.png"> Exit</a>
    </div>
  </div>
</div>
<div id="tour-navigation">
  ...
  <div class="tour-description col50">
    ...
    <div class="text">
      Your profile page is the way other members in the community find out more about you.
    </div>
  </div>
  <div class="tour-button col25">
    <a href="options.php">
...
<div id="tour-view">
  <img src="../img/tour-memberprofiles.png">
</div>
<div id="tour-footer">
  <div class="col25">
    &nbsp;
  ...
  <div class="col50">
    <img src="../img/tour-extra.png"> Members that provide a bio and teaching experience receive more connections.
  </div>
  <div class="col25">
    &nbsp;
  </div>
