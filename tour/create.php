...
<div id="tour-header">
  ...
  <div class="col50">
    <div class="tour-exit right">
      <a id="tour-exit-create" href="../home.php"><img src="../img/tour-exit.png"> Exit</a>
    </div>
  </div>
</div>
<div id="tour-navigation">
  ...
  <div class="tour-description col50">
    <h3>Post/Question Creator</h3>
    <div class="text">
      The contribute menu bar button allows you to publish a post or question to the community.
    </div>
  </div>
  <div class="tour-button col25">
    <a href="profile.php">
...
<div id="tour-view">
  <img src="../img/tour-postcreator.png">
</div>
<div id="tour-footer">
  <div class="col25">
    &nbsp;
  ...
  <div class="col50">
    <img src="../img/tour-extra.png"> Create a question instead of a post when you need help so that we can connect you with the right people.
  </div>
  <div class="col25">
    &nbsp;
  </div>
