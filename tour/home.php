...
<div id="tour-header">
  ...
  <div class="col50">
    <div class="tour-exit right">
      <a id="tour-exit-home" href="../home.php"><img src="../img/tour-exit.png"> Exit</a>
    </div>
  </div>
</div>
<div id="tour-navigation">
  ...
  <div class="tour-description col50">
    ...
    <div class="text">
      Your personal homepage is the first place to see what is new and popular within your communities.
    </div>
  </div>
  <div class="tour-button col25">
    <a href="posts.php">
...
<div id="tour-view">
  <img src="../img/tour-personalhomepage.png">
</div>
<div id="tour-footer">
  <div class="col25">
    &nbsp;
  ...
  <div class="col50">
    <img src="../img/tour-extra.png"> You can add more rows to your homepage by following people and joining communities.
  </div>
  <div class="col25">
    &nbsp;
  </div>
