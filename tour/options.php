...
<div id="tour-header">
  ...
  <div class="col50">
    <div class="tour-exit right">
      <a id="tour-exit-options" href="../home.php"><img src="../img/tour-exit.png"> Exit</a>
    </div>
  </div>
</div>
<div id="tour-navigation">
  ...
  <div class="tour-description col50">
    ...
    <div class="text">
      TeachersConnect is a shared space where all teachers collaborate to make a greater impact. Where do you want to start?
    </div>
  </div>
  <div class="tour-button col25">
    &nbsp;
...
<div id="tour-options">
  <a id="tour-end-home" href="../home.php"><img src="../img/tour-button-home.png"></a>
  <a id="tour-end-topics" href="../topics.php"><img src="../img/tour-button-topics.png"></a>
  <a id="tour-end-search" href="../home.php?searchfocus=1"><img src="../img/tour-button-search.png"></a>
  <a id="tour-end-profile" href="../edit-profile.php"><img src="../img/tour-button-profile.png"></a>
  <a id="tour-end-createpost" href="../feed.php?createpost=1"><img src="../img/tour-button-post.png"></a>
  <a id="tour-end-communities" href="../edit-affiliate.php"><img src="../img/tour-button-community.png"></a>
</div>
<div id="tour-footer">
  <div class="col25">
    &nbsp;
  ...
  <div class="col50">
    <img src="../img/tour-extra.png">
     If you need help using TeachersConnect, visit the <a href="<?php echo Config::MARKETING_URL; ?>/support/" target="_blank">support section</a> of our website.
  </div>
  <div class="col25">
    &nbsp;
  </div>
